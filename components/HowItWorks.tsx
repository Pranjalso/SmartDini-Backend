      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 animate-on-scroll">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">
            How <span className="text-brand-red">Smartdini</span> Works
          </h2>
        ...
        <div className="hidden lg:block absolute top-10 left-[9%] right-[9%] h-[3px] bg-red-300 rounded-full"></div>
        ...
        <div className="text-center mt-16 animate-on-scroll">
          <div className="bg-white rounded-2xl p-8 border border-border shadow-xl shadow-gray-200/60">
            <h3 className="text-2xl font-semibold mb-4">Ready to get started?</h3>
            <p className="text-muted-foreground mb-6">
              Join 25+ of cafes already using Smartdini
            </p>
