        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {customFeatures.map((feature, index) => (
              ...
              >
                {feature.premium && (
                  <div className="absolute top-4 right-4 bg-[#00BD61] text-white px-3 py-1 rounded-full text-xs font-medium shadow-sm">
                    Premium
                  </div>
                )}
          ...
          <div className="bg-gradient-to-br from-white to-gray-50/50 rounded-2xl p-8 shadow-lg border border-border">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="text-center">
                ...
                <button className="bg-[#00BD61] hover:bg-[#009C4F] text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 hover:shadow-lg hover:scale-105 active:scale-95">
